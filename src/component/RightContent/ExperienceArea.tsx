                    ...
                    <div className="space-y-10 md:space-y-12">
                        {Object.entries(TOTAL_EXPERIENCE).map(([eachKey, eachExperience], index, array) => {
                            ...
                            return (
                                <div
                                    key={eachKey}
                                    className={`relative pl-24 sm:pl-28 md:pl-20 ${
                                ...
                                >
                                    ...
                                    <a
                                        ...
                                        className="absolute left-0 top-2 z-10 flex h-16 w-16 items-center justify-center rounded-md border border-gray-100 bg-white shadow-[0_2px_8px_rgba(0,0,0,0.08)] transition-transform duration-300 hover:scale-110 sm:h-[72px] sm:w-[72px] md:left-[-50px] md:top-1 md:h-10 md:w-27 md:hover:scale-125"
                                    >
                                        <img
                                    ...
                                    <div className="flex flex-col gap-3">
                                        <div className="flex flex-col gap-3 md:gap-2">
                                            <div className="flex flex-col gap-2 [@media(orientation:landscape)]:flex-row [@media(orientation:landscape)]:items-center [@media(orientation:landscape)]:justify-between md:flex-row md:items-center md:justify-between">
                                                ...
                                                <span
                                                    className="
                                                        w-fit text-xs font-medium text-slate-600
                                                        [@media(orientation:landscape)]:ml-auto
                                                        [@media(orientation:landscape)]:inline-flex
                                                        [@media(orientation:landscape)]:items-center
                                                        [@media(orientation:landscape)]:rounded-[0.5rem]
                                                        [@media(orientation:landscape)]:border
                                                        [@media(orientation:landscape)]:border-slate-200
                                                        [@media(orientation:landscape)]:bg-slate-100
                                                        [@media(orientation:landscape)]:px-3
                                                        [@media(orientation:landscape)]:py-1
                                                        [@media(orientation:landscape)]:text-sm
                                                        [@media(orientation:landscape)]:font-semibold
                                                        [@media(orientation:landscape)]:text-black
                                                        md:ml-0
                                                        md:inline-flex
                                                        md:items-center
                                                        md:rounded-[0.5rem]
