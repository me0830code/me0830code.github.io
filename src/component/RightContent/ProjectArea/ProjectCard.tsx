...
export function ProjectCard({projectName, projectYear, projectDescription, projectPreviewImageURL, projectLinkURL, projectSkillSet, projectTag}: ProjectItem) {    
    return (
        <a href={projectLinkURL} target="_blank" rel="noopener noreferrer" className="group relative flex flex-row items-start gap-8 p-10 rounded-[0.5rem] bg-[#F8FAFC] border border-slate-100 hover:bg-white hover:shadow-[0_25px_20px_-15px_rgba(0,0,0,0.1)] hover:-translate-y-2 transition-all duration-300 min-h-[300px]">
                ...
                <div>
                    <div className="flex flex-row">
                        ...
                        <div className="mt-6 flex-1 shrink-0 flex items-center justify-end h-full">
                            <div className="relative w-full max-w-[180px] aspect-square overflow-hidden rounded-[2.5rem] bg-white border border-slate-200/50 shadow-inner group-hover:shadow-2xl group-hover:scale-110 transition-all duration-500">
