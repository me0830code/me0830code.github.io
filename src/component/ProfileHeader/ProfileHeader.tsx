                ...
                <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 text-sm font-semibold text-sky-600">
                        ...
                        <div className="flex items-center gap-1 sm:inline-flex sm:ml-1">
                            ...
                            <a href={COMPANY_INFO.COUPANG.companyLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center rounded-md py-1 mt-0.5 transition-all duration-200 hover:bg-red-50">
                                <img src={COMPANY_INFO.COUPANG.logoURL} alt={COMPANY_INFO.COUPANG.companyName} className="h-[1.1em] w-auto object-contain translate-y-[1px]"/>
                            </a>
                        </div>
                    </div>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
                {
                    TOTAL_INFO.map((eachInfo) => (
                        <a key={eachInfo.key} href={eachInfo.linkURL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-2 text-xs sm:text-sm font-medium text-slate-700 transition-all duration-200 hover:border-slate-300 hover:text-sky-600">
