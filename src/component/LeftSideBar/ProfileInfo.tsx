    ...
    return (
        <div className="space-y-3">
            ...
            <p className="mt-4 text-base text-sky-600 font-semibold">
                ...
                <a href={COMPANY_INFO[0].companyLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-4 py-1 -mx-2 rounded-md transition-all duration-200 hover:bg-red-50 group">
                    <img src={COMPANY_INFO[0].logoURL} alt={COMPANY_INFO[0].companyName} className="h-[1.1em] w-auto object-contain transition-transform group-hover:scale-105 align-middle translate-y-[5px]"/>
                </a>
            </p>
